import css from '../styles/productpage.module.css'
...
export default function Productpage(){
    return ( 
      ...
      <div className={css.filterBar}>
        <button className={`btn ${css.filterBtn}`}>Filter</button>
        <input
          type="text"
          placeholder="Default sorting"
          className={`btn ${css.searchInput}`}
        />
        </div>
